...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
   ...
   Semantic HTML, os meaningful html. For example <header><section><nav> Are semantic. These help search engines find your page and also helps with accessability.
...
4. Explain why git is valuable to a team of developers.
   ...
   Helps with version control. Easier to find bugs. Easier to collaborate within a team.

5. Define mobile-first design in your own words.

   Taking a mobile first approach means you start with designing a page for mobile than work up to the desktop size.
